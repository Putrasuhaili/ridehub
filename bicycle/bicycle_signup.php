...
<head>
  ...
  <title>Sign Up to Rent Bicycle - UMPSA RideHub</title>
  ...
  <style>
    ...
    .register-screen {
      background: url('../img/bicycle/bg2_bicycle.jpg') no-repeat center center;
    ...
    <div class="row">
      <div class="col-sm-5 col-md-4 login-block animate__animated animate__fadeInLeft">
        <div class="backend-main">
          ...
          <h1 class="text-center">SIGN UP TO RENT BICYCLE</h1>
          ...
          <form action="../includes/signupinc.php" method="post" class="needs-validation" novalidate>
            ...
            <input type="hidden" name="vehicle" value="bicycle">
          ...
          <p class="text-center mt-3">Already have an account? <a href="bicycle_login.php" class="text-warning">Click here</a>.</p>
        </div>
      </div>
