...
<head>
  ...
  <title>Log In to Rent Bicycle - UMPSA RideHub</title>
  ...
  <style>
    ...
    .login-screen {
      background: url('../img/bicycle/bg3_bicycle.jpg') no-repeat center center;
    ...
    <div class="row">
      ...
      <div class="col-sm-5 col-md-4 login-block animate__animated animate__fadeInLeft">
        <div class="backend-main">
          ...
          <h1 class="text-center">LOG IN TO RENT BICYCLE</h1>
          ...
          <form action="../includes/logininc.php" method="post" class="needs-validation" novalidate>
            ...
            <input type="hidden" name="vehicle" value="bicycle"> <!-- or car, scooter, motorcycle -->
            ...
            <br>
            <p class="text-center">Don't have an account? <a href="..\bicycle\bicycle_signup.php" class="text-warning">Sign up here</a>.</p>
          </form>
        </div>
      </div>
