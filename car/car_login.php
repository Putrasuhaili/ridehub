...
<head>
  ...
  <title>Log In to Rent Car - UMPSA RideHub</title>
  ...
  <style>
    ...
    .login-screen {
      background: url('../img/cars/bg_car_login.jpg') no-repeat center center;
    ...
    <div class="row">
      ...
      <div class="col-sm-5 col-md-4 login-block animate__animated animate__fadeInLeft">
        <div class="backend-main">
          ...
          <h1 class="text-center">LOG IN TO RENT CAR</h1>
          ...
          <form action="../includes/logininc.php" method="post" class="needs-validation" novalidate>
            ...
            <input type="hidden" name="vehicle" value="car"> <!-- Changed from bicycle to car -->
            ...
            <br>
            <p class="text-center">Don't have an account? <a href="..\car\car_signup.php" class="text-warning">Sign up here</a>.</p>
          </form>
        </div>
      </div>
