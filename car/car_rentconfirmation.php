<?php
    ...
    if (!isset($_GET['carID']) || !isset($_SESSION['userUid'])) {
    ...
    $result = $conn->query("SELECT * FROM cars WHERE carID='$carID'") or die($conn->error);
?>
...
<head>
    <meta charset="UTF-8">
    <title>Car Rent Payment Confirmation</title>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item"><a class="nav-link text-light disabled animate__animated animate__flipInX" href="#">Car Rent Confirmation</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<div class="container col-md-8 bg-white mt-5 mb-5 p-4 animate__animated animate__fadeIn border rounded">
    <form action="rent.inc.php" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" value="<?php echo $row['carName']; ?>" readonly>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" name="payment" readonly value="<?php echo number_format($row['carPrice'], 2); ?>">
            </div>
        </div>

        <div class="form-group text-center mt-4">
            <a href="car_home.php" class="btn btn-outline-primary px-5">Cancel</a>
