...
<head>
  ...
  <title>Sign Up to Rent Car - UMPSA RideHub</title>
  ...
  <style>
    ...
    .register-screen {
      background: url('../img/cars/bg2_car.jpg') no-repeat center center;
    ...
    <div class="row">
      <div class="col-sm-5 col-md-4 login-block animate__animated animate__fadeInLeft">
        <div class="backend-main">
          ...
          <h1 class="text-center">SIGN UP TO RENT CAR</h1>
          ...
          <p class="text-center mt-3">Already have an account? <a href="car_login.php" class="text-warning">Click here</a>.</p>
        </div>
      </div>
