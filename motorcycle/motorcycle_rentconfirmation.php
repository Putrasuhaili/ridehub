...
if (!isset($_GET['motorcycleID']) || !isset($_SESSION['userUid'])) {
...
// Get selected motorcycle details
$result = $conn->query("SELECT * FROM motorcycles WHERE motorcycleID='$motorcycleID'") or die($conn->error);
?>
...
<div class="container col-md-8 bg-white mt-5 mb-5 p-4 animate__animated animate__fadeIn border rounded">
    <form action="rent.inc.php" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" value="<?php echo $row['motorcycleName']; ?>" readonly>
                <input type="hidden" name="motorcycleID" value="<?php echo $row['motorcycleID']; ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" name="payment" readonly value="<?php echo number_format($row['motorcyclePrice'], 2); ?>">
            </div>
        </div>

        <div class="form-group text-center mt-4">
            <a href="motorcycle_home.php" class="btn btn-outline-primary px-5">Cancel</a>
